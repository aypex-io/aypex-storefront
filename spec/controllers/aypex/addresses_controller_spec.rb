...
describe Aypex::AddressesController, type: :controller do
  ...
  describe "#update" do
    ...
    context "when address is editable" do
      ...
      context "with data is valid" do
        ...
        it "sets flash message" do
          ...
          expect(flash[:notice]).to eq Aypex.t(:successfully_updated, scope: :address_book)
        end
        ...
        it "redirects to /account" do
          ...
          expect(response).to redirect_to(aypex.addresses_path)
        end
      end
    ...
    context "when address is not editable" do
      ...
      context "with data is valid" do
        ...
        it "creates address" do
          expect { put_update }.to change { Aypex::Address.count }.by(1)
        end
      ...
      context "when data is not valid" do
        ...
        it "does not create address" do
          expect { put_update }.to change { Aypex::Address.count }.by(0)
        end
