module Aypex
  module ProductFilterHelper
    ...
    CLEAR_ALL_FILTERS_LINK_CSS_CLASSES = 'btn aypex-btn btn-outline-primary w-100 mb-4'.freeze
    ...
    def min_price_filter_input(**html_options)
      price_filter_input(
        ...
        placeholder: "#{currency_symbol(current_currency)} #{Aypex.t(:min)}",
        **html_options
      )
    end
    ...
    def max_price_filter_input(**html_options)
      price_filter_input(
        ...
        placeholder: "#{currency_symbol(current_currency)} #{Aypex.t(:max)}",
        **html_options
      )
    end
    ...
    def price_filter_input(name:, value:, placeholder:, **html_options)
      ...
      style_class = "aypex-flat-input #{html_options[:class]}"
      ...
      link_to new_params, data: { params: new_params, id: id, filter_name: ot_downcase_name, multiselect: true } do
        ...
        if color_option_type_name.present? && color_option_type_name.downcase == ot_downcase_name
          content_tag :span, class: 'd-inline-block mb-1' do
            render partial: 'aypex/shared/color_select', locals: {
    ...
    def clear_all_filters_link(permitted_params, opts = {})
      ...
      link_to Aypex.t('plp.clear_all'), sort_by_param, class: opts[:css_class], data: { params: sort_by_param }
    end
