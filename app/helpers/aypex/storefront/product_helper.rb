  ...
  module Storefront
    module ProductHelper
      ...
      def variant_price_diff(variant)
        ...
        "(#{I18n.t("aypex.storefront.#{label}")}: #{amount})".html_safe
      end
      ...
      def line_item_description_text(description_text)
        if description_text.present?
          ...
          I18n.t("aypex.storefront.product_has_no_description")
        end
      end
      ...
      def available_status(product)
        return I18n.t("aypex.storefront.archived") if product.discontinued?
        return I18n.t("aypex.storefront.deleted") if product.deleted?

        if product.available?
          I18n.t("aypex.storefront.active")
        elsif product.make_active_at&.future?
          I18n.t("aypex.storefront.pending_sale")
        else
          I18n.t("aypex.storefront.draft")
        end
      end
